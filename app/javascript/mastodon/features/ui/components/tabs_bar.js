...
export const links = [
  ...
  <NavLink className='tabs-bar__link' to='/timelines/wfctag/worstfriendschat' data-preview-title-id='column.hashtag' data-preview-icon='hashtag' ><Icon id='hashtag' fixedWidth /><FormattedMessage id='tabs_bar.hashtag_timeline' defaultMessage='Hashtag' /></NavLink>,
